...
<aside id="sidebar" class="w-64 flex flex-col h-screen transition-all duration-300 relative z-40 border-r border-sidebar-border bg-sidebar shrink-0">
    ...
    <nav class="flex-1 px-3 space-y-1.5 overflow-y-auto py-2">
        <a href="index.jsp" data-page="index.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
            <i data-lucide="layout-dashboard" class="size-5"></i>
            <span class="text-sm font-medium">Dashboard</span>
        </a>
        <a href="parking-slots.jsp" data-page="parking-slots.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
            <i data-lucide="parking-square" class="size-5"></i>
            <span class="text-sm font-medium">Parking Slots</span>
        </a>
        <a href="analytics.jsp" data-page="analytics.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
        ...
        <a href="membership.jsp" data-page="membership.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
            <i data-lucide="users" class="size-5"></i>
            <span class="text-sm font-medium">Membership</span>
        </a>
        <a href="membership-analytics.jsp" data-page="membership-analytics.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
        ...
        <a href="settings.jsp" data-page="settings.jsp" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group hover:bg-green-500/5 text-sidebar-foreground/60 hover:text-green-500">
